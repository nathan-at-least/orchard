use crate::{
    ...
    primitives::tweedlesig::{self, Binding, SpendAuth},
    tree::Anchor,
...
pub struct Action {
    ...
    rk: tweedlesig::VerificationKey<SpendAuth>,
...
impl Bundle {
    ...
    ) -> (Self, tweedlesig::SigningKey<Binding>) {
        todo!()
    }
...
pub struct SignedBundle {
    bundle: Bundle,
    action_signatures: Vec<tweedlesig::Signature<SpendAuth>>,
    binding_signature: tweedlesig::Signature<Binding>,
}
...
impl SignedBundle {
    ...
    /// Computes a commitment to the authorizing signatures for this bundle.
    ///
    /// This together with `SignedBundle::commitment` bind the entire bundle.
    pub fn witness_commitment(&self) -> BundleWitnessCommitment {
        todo!()
    }
}
...
pub struct BundleWitnessCommitment;
